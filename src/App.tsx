...
import type { DefaultLanding } from './contexts/settings-context';
import type { Role } from './api/types';

function homeForRole(role: Role | null, defaultLanding: DefaultLanding = 'role'): string {
  if (defaultLanding === 'deliverables') return '/deliverables';
  if (defaultLanding === 'my-reviews') return '/my-reviews';
  if (defaultLanding === 'dashboard' && role !== 'ENGINEER') return '/dashboard';
...
function HomeRedirect() {
  ...
  return <Navigate to={homeForRole(role, settings.defaultLanding)} replace />;
}
